# from a comment at https://www.researchgate.net/post/Does_anybody_have_code_for_
#                   running_a_logistic_exposure_nest_survival_model_in_R
...
exdat <- structure(list(nest = c(1L, 1L, 1L, 1L, 1L, 12L, 12L, 12L, 12L, 16L, 16L, 
                                 ...
                                 17L), 
                        spnum = structure(c(9L, 9L, 9L, 9L, 9L, 9L, 
                                            9L, 9L, 9L, 9L, 9L, 9L,
                                            9L, 9L, 9L, 9L, 9L, 9L, 
                                            9L, 9L, 9L, 9L, 9L, 9L, 
                                            9L, 9L, 9L, 9L, 9L, 9L, 
